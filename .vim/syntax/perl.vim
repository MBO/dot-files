...
syn match perlStatementProc		"\<\%(alarm\|blessed\|confess\|exec\|fork\|get\%(pgrp\|ppid\|priority\)\|has\|inner\|is\|kill\|mutable\|pipe\|set\%(pgrp\|priority\)\|sleep\|super\|system\|times\|wait\%(pid\)\=\)\>"
...
syn match perlMethodName +\%(\h\|::\|'\w\)\%(\w\|::\|'\w\)*\_s*\|+ contained
